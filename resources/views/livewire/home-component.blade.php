                            ...
                            <div class="row align-items-center slider-animated-1">
                                <div class="col-lg-5 col-md-6">
                                    <div class="hero-slider-content-2">
                                        ...
                                        <a class="animated btn btn-brush btn-brush-3" href="{{ $item->link }}"> Shop
                                            Now </a>
                                    </div>
                                </div>
                                <div class="col-lg-7 col-md-6">
                                    <div class="single-slider-img single-slider-img-1">
                                        <img class="animated slider-1-1"
                                            src="{{ asset('assets/imgs/slider') }}/{{ $item->image }}" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 col-6">
                                    <div class="product-cart-wrap mb-30">
                                        ...
                                        <div class="product-content-wrap">
                                            ...
                                            <h2><a
                                                    href="{{ route('product.details', ['slug' => $fproduct->slug]) }}">{{ $fproduct->ten }}</a>
                                            </h2>
                                            ...
                                            <div class="product-price">
                                                <span>{{ $fproduct->gia_sale }} đ</span>
                                                <span class="old-price">{{ $fproduct->gia }}đ</span>
                                            </div>
                                            <div class="product-action-1 show">
                                                <a aria-label="Add To Cart" class="action-btn hover-up"
                                                    href="{{ route('product.details', ['slug' => $fproduct->slug]) }}"><i
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 col-6">
                                    <div class="product-cart-wrap mb-30">
                                        ...
                                        <div class="product-content-wrap">
                                            ...
                                            <h2><a
                                                    href="{{ route('product.details', ['slug' => $pproduct->slug]) }}">{{ $pproduct->ten }}</a>
                                            </h2>
                                            <div class="rating-result" title="90%">
                                                <span>
                                                    <span>90%</span>
                                            ...
                                            <div class="product-action-1 show">
                                                <a aria-label="Add To Cart" class="action-btn hover-up"
                                                    href="{{ route('product.details', ['slug' => $pproduct->slug]) }}"><i
                                                        class="fi-rs-shopping-bag-add"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 col-6">
                                    <div class="product-cart-wrap mb-30">
                                        <div class="product-img-action-wrap">
                                            <div class="product-img product-img-zoom">
                                                <a href="{{ route('product.details', ['slug' => $laproduct->slug]) }}">
                                                    <img class="default-img"
                                                        src="{{ asset('assets/imgs/products') }}/{{ $laproduct->image }}"
                                                        alt="">
                                        ...
                                        <div class="product-content-wrap">
                                            ...
                                            <h2><a
                                                    href="{{ route('product.details', ['slug' => $laproduct->slug]) }}">{{ $laproduct->ten }}</a>
                                            </h2>
                                            <div class="rating-result" title="90%">
                                                <span>
                                                    <span>90%</span>
                                            ...
                                            <div class="product-action-1 show">
                                                <a aria-label="Add To Cart" class="action-btn hover-up"
                                                    href="{{ route('product.details', ['slug' => $laproduct->slug]) }}"><i
                                                        class="fi-rs-shopping-bag-add"></i></a>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="container">
                <div class="banner-img banner-big wow fadeIn animated f-none">
                    ...
                    <div class="banner-text d-md-block d-none">
                        ...
                        <a href="{{ route('shop') }}" class="btn">{{ __('Tìm hiểu thêm') }} <i
                            ...
                            <div class="card-1">
                                <figure class=" img-hover-scale overflow-hidden">
                                    <a href="{{ route('product.category', ['slug' => $pcategory->slug]) }}"><img
                                            src="{{ asset('assets/imgs/category') }}/{{ $pcategory->image }}"alt=""></a>
                                </figure>
                                <h5><a
                    ...
                    <div class="carausel-6-columns carausel-arrow-center" id="carausel-6-columns-2">
                        @foreach ($lproducts as $lproduct)
                            <div class="product-cart-wrap small hover-up">
                                ...
                                <div class="product-content-wrap">
                                    <h2><a href="product-details.html">{{ $lproduct->ten }}</a></h2>
                                    <div class="rating-result" title="90%">
                                        <span>
                                        </span>
                                    </div>
