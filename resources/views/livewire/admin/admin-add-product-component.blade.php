                            ...
                            <form wire:submit.prevent="addProduct()">
                                ...
                                <div class="mb-3 mt-3">
                                    ...
                                    <input type="text" name="slug" class="form-control"
                                        placeholder="Nhập slug sản phẩn"wire:model="slug" />
                                    @error('slug')
                                        <p class="text-danger">{{ $message }} </p>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3 mt-3">
                                    ...
                                    <input type="text" name="sale_price" class="form-control"
                                        placeholder="Nhập giá sale"wire:model="sale_price" />
                                    @error('sale_price')
                                        <p class="text-danger">{{ $message }} </p>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3 mt-3">
                                    ...
                                    <input type="text" name="quanity" class="form-control"
                                        placeholder="Nhập số lượng"wire:model="quanity" />
                                    @error('quanity')
                                        <p class="text-danger">{{ $message }} </p>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3 mt-3">
                                    ...
                                    <input type="file" name="image" class="form-control" wire:model="images"
                                        multiple />
                                    @if ($images)
                                ...
                                @foreach ($inputs as $key => $value)
                                    <div class="mb-3 mt-3">
                                        <label class="form-label">
                                            {{ $pattributes->where('id', $attr_array[$key])->first()->name }}</label>
                                        <div class="row">
                                            <div class="col-lg-10">
                                                <input type="text" class="form-control"
                                                    placeholder="{{ $pattributes->where('id', $attr_array[$key])->first()->name }}"wire:model="attr_values.{{ $value }}" />
                                            </div>
                                            <div class="col-lg-2"><button class="btn btn-danger float-end"
